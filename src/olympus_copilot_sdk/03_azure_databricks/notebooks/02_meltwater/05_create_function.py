...
from olympus_databricks.sources.meltwater import lookup_function_step
...
configure_logging()
with job_run(logging.getLogger(__name__), "create_lookup_function", config.name):
    execute_step(spark, lookup_function_step(config))
