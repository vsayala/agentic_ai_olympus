...
from olympus_databricks.sources.meltwater import silver_step
...
configure_logging()
with job_run(logging.getLogger(__name__), "silver", config.name):
    execute_step(spark, silver_step(config))
