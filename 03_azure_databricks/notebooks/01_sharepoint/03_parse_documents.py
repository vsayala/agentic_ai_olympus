...
from olympus_databricks.sources.sharepoint import parse_documents_step
...
configure_logging()
with job_run(logging.getLogger(__name__), "parse_documents", config.name):
    execute_step(spark, parse_documents_step(config))
